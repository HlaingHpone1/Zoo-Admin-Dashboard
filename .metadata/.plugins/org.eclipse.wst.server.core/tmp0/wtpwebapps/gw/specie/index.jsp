...
<head>
	...
	<title>Admin Specie Index page</title>
	 ...
	 <main class="mt-5">
        <div class="container-fluid">
            <div class="row justify-content-end">
                <div class="display-1 text-white text-center">Species Dashboard</div>
                
                <div class="col-md-2 mb-3">
	                <a class="btn btn-primary" href="./add.jsp" role="button"><i class="fa-solid fa-sitemap me-2"></i>Add Specie</a>
	            </div>
           
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <i class="fa-solid fa-sitemap me-2"></i>Species
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <%
									...
									ArrayList<Species> mySpecie=sManager.fetchAll();
                                ...
                                <table id="datatable" class="table w-100">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Species Type</th>
                                            <th class="text-center">Species Group</th>
                                            <th class="text-center">Life Style</th>
                                    ...
                                    <tbody>
                                    	<% for(Species species:mySpecie){%>
                                        <tr>
											<td class="text-center"><%= species.getSpecieID() %></td>
											<td class="text-center"><%= species.getSpecieType() %></td>
											<td class="text-center"><%= species.getSpecieGroup() %></td>
											<td class="text-center"><%= species.getLifeStyle() %></td>
											<td class="text-center"><%= species.getConservationStatus() %></td>
											<td class="text-center">
                                                <a href="./update.jsp?id=<%= species.getSpecieID() %>" class="btn btn-primary"><i class="fa-solid fa-pen-to-square me-2" role="button"></i>Edit</a>
                                            </td>
                                            <td class="text-center">
                                                <a href="./delete.jsp?id=<%= species.getSpecieID() %>" class="btn btn-danger" onclick="myFunction()"><i class="fa-solid fa-trash me-2" role="button"></i>Delete</a>
                                            </td>
										</tr>
										<% }  %>
