...
<head>
	...
	<title>Admin Species Index page</title>
...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top ">
		<div class="container-fluid">
			...
			<a class="navbar-brand me-auto ms-lg-0 ms-3 text-uppercase fs-1 fw-bold" href="../user/index.php">Go Wild Wildlife Park Dashboard</a>
			<button
			class="navbar-toggler"
			type="button"
	 ...
	 <main class="mt-5">
        <div class="container-fluid">
            <div class="row justify-content-end">
              	<div class="h1 text-center">Specie Dashboard</div>
                                ...
                                <table id="datatable" class="table w-100">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Specie Type</th>
                                            <th class="text-center">Specie Group</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
											...
											<td class="text-center">Hlaing</td>
											<td class="text-center">Hpone</td>
											<td class="text-center">Leo</td>
											<td class="text-center">Pazuntaung</td>
											<td class="text-center">
                                                <a href="./update.jsp" class="btn btn-primary"><i class="fa-solid fa-pen-to-square me-2" role="button"></i>Edit</a>
                                            </td>
                                            <td class="text-center">
                                                <a href="./delete.jsp" class="btn btn-danger"><i class="fa-solid fa-trash me-2" role="button"></i>Delete</a>
                                            </td>
										</tr>
