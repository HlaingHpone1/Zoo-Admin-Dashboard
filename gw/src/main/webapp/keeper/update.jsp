...
<head>
	...
	<title>Admin Edit Keeper page</title>
    ...
    <div class="container-fluid my-3 " >
        ...
        <input type ="hidden" name="keeper_id" value="<%= k.getKeeperID() %>">
            ...
            <div class="row">
                <div class="col-md-12">
                    <!-- Header info -->
                    <h1 class="display-1 text-white text-center mb-5">Edit Keeper</h1>
                </div>
            </div>
            ...
            <div class="row justify-content-center py-3">
                <div class="col-md-6">
                    <div class="form-floating">
                        <input type="text" class="form-control" id="floatingInput" name="keepers_name" placeholder="Keeper Name" value="<%= k.getName() %>" required>
            ...
            <div class="row justify-content-center py-3">
                <div class="col-md-3">
                    <div class="form-floating">
                        <input type="text" class="form-control" id="floatingInput" name="dob" placeholder="Date Of Birth" value="<%= new SimpleDateFormat("yyyy-MM-dd").format((Date) k.getDateOfBirth()) %>"  required>
                        <label for="floatingInput">Date Of Birth (yyyy-mm-dd)</label>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-floating">
                        <input type="text" class="form-control" id="floatingInput" name="keeper_rank" placeholder="Keeper Rank" value="<%= k.getKeeper_rank() %>" required>
