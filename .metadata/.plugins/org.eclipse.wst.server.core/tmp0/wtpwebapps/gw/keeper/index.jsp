...
<head>
	...
	<title>Admin Keeper Index page</title>
	 ...
	 <main class="mt-5">
        <div class="container-fluid">
            <div class="row justify-content-end">
                <div class="display-1 text-white text-center">Keeper Dashboard</div>
                
                <div class="col-md-2 mb-3">
	                <a class="btn btn-primary" href="./add.jsp" role="button"><i class="fa-solid fa-users-line me-2"></i>Add Keeper</a>
	            </div>
           
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <i class="fa-solid fa-users-line me-2"></i>Keepers
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <% 
                                	...
                                	ArrayList<Keepers> myKeeper = kManager.fetchAll();
                                %>
                                <table id="datatable" class="table w-100">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Keeper Rank</th>
                                            <th class="text-center">Action</th>
                                            <th class="text-center">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    	<% for(Keepers keepers:myKeeper){ %>
                                        <tr>
											<td class="text-center"><%= keepers.getKeeperID() %></td>
											<td class="text-center"><%= keepers.getName() %></td>								
											<td class="text-center"><%=new SimpleDateFormat("yyyy-MM-dd").format((Date) keepers.getDateOfBirth())%></td>
									
											<td class="text-center"><%= keepers.getKeeper_rank() %></td>
											<td class="text-center">
                                                <a href="./update.jsp?id=<%= keepers.getKeeperID() %>" class="btn btn-primary"><i class="fa-solid fa-pen-to-square me-2" role="button"></i>Edit</a>
                                            </td>
                                            <td class="text-center">
                                                <a href="./delete.jsp?id=<%= keepers.getKeeperID() %>" class="btn btn-danger" onclick="myFunction()"><i class="fa-solid fa-trash me-2" role="button"></i>Delete</a>
                                            </td>
										</tr>
										<%} %>
