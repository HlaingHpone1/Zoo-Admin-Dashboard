...
<head>
	...
	<title>Admin Enclosure Index page</title>
	 ...
	 <main class="mt-5">
        <div class="container-fluid">
            <div class="row justify-content-end">
               	<div class="display-1 text-white text-center">Enclosure Dashboard</div>
            
	            <div class="col-md-2 mb-3">
	                <a class="btn btn-primary" href="./add.jsp" role="button"><i class="fa-solid fa-mountain-city me-2"></i>Add Enclosure</a>
	            </div>
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <i class="fa-solid fa-mountain-city me-2"></i>Enclosures
                        </div>
                        <div class="card-body">
                                ...
                                <table id="datatable" class="table w-100">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Enclosure Type</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
											<td class="text-center"><%= enclosures.getEnclosureID() %></td>
											<td class="text-center"><%= enclosures.getEnclosureType() %></td>
											<td class="text-center"><%= enclosures.getLocation() %></td>
											<td class="text-center">
                                                <a href="./update.jsp?id=<%= enclosures.getEnclosureID() %>" class="btn btn-primary"><i class="fa-solid fa-pen-to-square me-2" role="button"></i>Edit</a>
                                            </td>
                                            <td class="text-center">
                                                <a href="./delete.jsp?id=<%= enclosures.getEnclosureID() %>" class="btn btn-danger" onclick="myFunction()"><i class="fa-solid fa-trash me-2" role="button"></i>Delete</a>
                                            </td>
										</tr>
										<% }  %>
                                    </tbody>
