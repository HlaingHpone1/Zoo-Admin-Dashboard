	...
	<div
		...
		<div class="offcanvas-body p-0">
			...
			<ul class="navbar-nav">
				...
				<li>
                    <a href="../main.jsp" class="nav-link px-3 active">
	 ...
	 <main class="mt-5">
        <div class="container-fluid ">
            <div class="row justify-content-end">
            	<div class="display-1 text-white text-center">Animal Dashboard</div>
            	
            	<div class="col-md-2 mb-3">
                    <a class="btn btn-primary" href="./add.jsp" role="button"><i class="fa-solid fa-paw me-2"></i>Add Animal</a>
                </div>
                                ...
                                <table id="datatable" class="table w-100">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center">Year of Arrival</th>
                                            <th class="text-center">Keeper ID</th>
                                            <th class="text-center">Enclosure ID</th>
                                            <th class="text-center">Diet ID</th>
                                            <th class="text-center">Species ID	</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
											<td class="text-center"><%= animals.getAnimalID() %></td>
											<td class="text-center"><%= animals.getName() %></td>
											<td class="text-center"><%= animals.getGender() %></td>
											<td class="text-center"><%= animals.getYearOfArrival() %></td>
											<td class="text-center"><%= animals.getKeeperID() %></td>
											<td class="text-center"><%= animals.getDietID() %></td>
											<td class="text-center"><%= animals.getEnclosureID() %></td>
											<td class="text-center"><%= animals.getSpecieID() %></td>
											<td class="text-center">
                                                <a href="./update.jsp?id=<%= animals.getAnimalID() %>" class="btn btn-primary"><i class="fa-solid fa-pen-to-square me-2" role="button"></i>Edit</a>
                                            </td>
                                            <td class="text-center">
                                                <a href="./delete.jsp?id=<%= animals.getAnimalID() %>" class="btn btn-danger" onclick="myFunction()"><i class="fa-solid fa-trash me-2" role="button"></i>Delete</a>
                                            </td>
										</tr>
										<%} %>
                                    </tbody>
